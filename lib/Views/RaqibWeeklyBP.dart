...
class RaqibWeeklyBP extends StatefulWidget {
  final Widget child;

  RaqibWeeklyBP({Key key, this.child}) : super(key: key);
  @override
  _RaqibWeeklyBPState createState() => _RaqibWeeklyBPState();
}

class _RaqibWeeklyBPState extends State<RaqibWeeklyBP> {
    ...
    _seriesData.add(
      charts.Series(
       ...
       fillColorFn: (Pollution pollution, _) =>
          charts.ColorUtil.fromDartColor(Colors.blue[50]),
      ),
    );
  }
  @override
